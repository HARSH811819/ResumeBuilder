...
function One() {
  ...
  return (
    <div className="w-[820px] flex-col mx-auto my-2 items-center justify-center ">
      ...
      >
        {/* Side Intro Section */}
        <div className="basicinfor bg-gray-600 rounded-e-xl h-full w-[250px] flex-col items-center justify-center  pt-4">
          {/* Profile imge */}
          <div className="profilePic mt-9 mx-auto   max-h-[200px] max-w-[130px] min-w-[120px]  overflow-hidden bg-gray-200 rounded-2xl border border-white flex justify-center items-center">
            <img
              id="profile"
              src={profile.src}
              alt=""
